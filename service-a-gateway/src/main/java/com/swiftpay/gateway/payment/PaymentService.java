...
import com.swiftpay.gateway.account.BalanceCache;
import com.swiftpay.gateway.common.BadRequestException;
import com.swiftpay.gateway.common.InsufficientFundsException;
...
// Gateway logic: idempotency (Redis + DB) -> validate (Redis-cached balance) -> save PENDING -> emit event.
@Service
